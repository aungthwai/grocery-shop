        ...
        <main class="dashboard-main-content">
            ...
            <div class="products-page">
                ...
                <?php if (isset($_GET['msg']) && $_GET['msg'] === 'added'): ?>
                    <div class="alert alert-success" style="padding:12px 16px; background:#dcfce7; color:#15803d; border-radius:8px; margin-bottom:16px; font-weight:600;">
                        ✅ Product added successfully to the list!
                    </div>
                <?php endif; ?>
